...
export class ChangeUser1673364024469 implements MigrationInterface {
    name = 'ChangeUser1673364024469'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`role\` enum ('USER', 'CUSTOMER', 'ADMIN') NOT NULL DEFAULT 'USER'`);
